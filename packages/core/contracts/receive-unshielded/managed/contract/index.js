...
const _descriptor_2 = new _Either_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      takeNight: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`takeNight: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('takeNight',
                                     'argument 1 (as invoked from Typescript)',
                                     'recv.compact line 10 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._takeNight_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { takeNight: this.circuits.takeNight };
    this.provableCircuits = { takeNight: this.circuits.takeNight };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('takeNight', new __compactRuntime.ContractOperation());
  ...
  _takeNight_0(context, partialProofData) {
