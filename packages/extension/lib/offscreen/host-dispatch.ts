...
export const hostDispatch: Dispatch = {
  ...
  'os/shieldedRebuild': (host, d) => host.shieldedRebuild(d.seedHex, d.walletName, d.network),
  'os/shieldedCoinsGet': (host, d) => host.shieldedCoinsGet(d.seedHex, d.walletName, d.network),
