...
> credential cleanup now live in **[NPM_PUBLISHING.md](./NPM_PUBLISHING.md)**.
...
state. See the npm publishing runbook for trusted-publisher configuration, verification, and
credential cleanup.
